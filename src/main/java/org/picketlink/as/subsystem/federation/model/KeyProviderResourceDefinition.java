...
public class KeyProviderResourceDefinition extends AbstractResourceDefinition {
    ...
    public static final SimpleAttributeDefinition URL = new SimpleAttributeDefinitionBuilder(
            ModelElement.COMMON_URL.getName(), ModelType.STRING, false).setAllowExpression(true).build();
    public static final SimpleAttributeDefinition PASSWD = new SimpleAttributeDefinitionBuilder(
            ModelElement.KEY_STORE_PASSWD.getName(), ModelType.STRING, false).setAllowExpression(true).build();
    public static final SimpleAttributeDefinition SIGN_KEY_ALIAS = new SimpleAttributeDefinitionBuilder(
            ModelElement.KEY_STORE_SIGN_KEY_ALIAS.getName(), ModelType.STRING, false).setAllowExpression(true).build();
    public static final SimpleAttributeDefinition SIGN_KEY_PASSWD = new SimpleAttributeDefinitionBuilder(
            ModelElement.KEY_STORE_SIGN_KEY_PASSWD.getName(), ModelType.STRING, false).setAllowExpression(true).build();
    ...
    private KeyProviderResourceDefinition() {
        super(ModelElement.KEY_STORE, new KeyProviderAddHandler(), ReloadRequiredRemoveStepHandler.INSTANCE, URL, PASSWD, SIGN_KEY_ALIAS, SIGN_KEY_PASSWD);
    }
