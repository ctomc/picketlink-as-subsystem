...
public class PicketLinkSubsystemReader_1_0 implements XMLStreamConstants, XMLElementReader<List<ModelNode>> {
    ...
    private void parseFederation(final XMLExtendedStreamReader reader, final ModelNode subsystemNode, final List<ModelNode> addOperations) throws XMLStreamException {
        ...
        parseElement(new ElementParser() {
            ...
            public void parse(final XMLExtendedStreamReader reader, final ModelElement element, final ModelNode parentNode, List<ModelNode> addOperations) throws XMLStreamException {
                switch (element) {
                    case KEY_STORE:
                        parseConfig(reader, KEY_STORE, KeyProviderResourceDefinition.SIGN_KEY_ALIAS.getName(),
                                parentNode, KeyProviderResourceDefinition.INSTANCE.getAttributes(), addOperations);
                        break;
                    case SAML:
    ...
    private void parseServiceProviderConfig(final XMLExtendedStreamReader reader, ModelNode federationNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
        ModelNode serviceProviderNode = parseConfig(reader, SERVICE_PROVIDER, ServiceProviderResourceDefinition.ALIAS.getName(), federationNode,
    ...
    private void parseHandlerConfig(final XMLExtendedStreamReader reader, final ModelNode entityProviderNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
        ModelNode handlerNode = parseConfig(reader, COMMON_HANDLER, HandlerResourceDefinition.CLASS.getName(), entityProviderNode,
                HandlerResourceDefinition.INSTANCE.getAttributes(), addOperations);
    ...
    private void parseIdentityProviderConfig(final XMLExtendedStreamReader reader, final ModelNode federationNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
        ModelNode identityProviderNode = parseConfig(reader, IDENTITY_PROVIDER, IdentityProviderResourceDefinition.ALIAS.getName(), federationNode,
    ...
    private void parseIdentityManagementConfig(final XMLExtendedStreamReader reader, final ModelNode parentNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
        ModelNode identityManagementNode = parseConfig(reader, IDENTITY_MANAGEMENT, IdentityManagementResourceDefinition.ALIAS.getName(), parentNode,
    ...
    private void parseIdentityConfigurationConfig(final XMLExtendedStreamReader reader, final ModelNode parentNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
    ...
    private void parseJPAStoreConfig(final XMLExtendedStreamReader reader, final ModelNode identityConfigurationNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
    ...
    private void parseFileStoreConfig(final XMLExtendedStreamReader reader, final ModelNode identityManagementNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
    ...
    private void parseLDAPStoreConfig(final XMLExtendedStreamReader reader, final List<ModelNode> addOperations, final ModelNode identityManagementNode)
            throws XMLStreamException {
    ...
    private void parseLDAPMappingConfig(final XMLExtendedStreamReader reader, final ModelNode identityProviderNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
        ModelNode ldapMappingConfig = parseConfig(reader, LDAP_STORE_MAPPING, LDAPStoreMappingResourceDefinition.CLASS.getName(), identityProviderNode,
            ...
            public void parse(final XMLExtendedStreamReader reader, final ModelElement element, final ModelNode parentNode, List<ModelNode> addOperations) throws XMLStreamException {
                switch (element) {
                    case LDAP_STORE_ATTRIBUTE:
                        parseConfig(reader, LDAP_STORE_ATTRIBUTE, LDAPStoreAttributeResourceDefinition.NAME.getName(), parentNode,
                                LDAPStoreAttributeResourceDefinition.INSTANCE.getAttributes(), addOperations);
                        break;
                }
            }
    ...
    private ModelNode parseCredentialHandlerConfig(XMLExtendedStreamReader reader, ModelNode identityProviderNode, List<ModelNode> addOperations)
            throws XMLStreamException {
        return parseConfig(reader, IDENTITY_STORE_CREDENTIAL_HANDLER, CredentialHandlerResourceDefinition.CLASS.getName(), identityProviderNode,
                CredentialHandlerResourceDefinition.INSTANCE.getAttributes(), addOperations);
    }

    private ModelNode parseSupportedTypesConfig(final XMLExtendedStreamReader reader, final ModelNode identityStoreNode, final List<ModelNode> addOperations)
            throws XMLStreamException {
     ...
     * @param attributes AttributeDefinition instances to be used to extract the attributes and populate the resulting
     * model.
     *
     ...
     * @throws XMLStreamException
     */
    private ModelNode parseConfig(XMLExtendedStreamReader reader, ModelElement xmlElement, String key,
                                  ModelNode lastNode, List<SimpleAttributeDefinition> attributes, List<ModelNode> addOperations) throws XMLStreamException {
    ...
    private void parseElement(final ElementParser parser, ModelElement parentElement, final ModelNode parentNode, final XMLExtendedStreamReader reader, final List<ModelNode> addOperations) throws XMLStreamException {
        while (reader.hasNext() && reader.nextTag() != END_DOCUMENT) {
            if (!reader.isStartElement()) {
    ...
    private interface ElementParser {
        ...
        void parse(XMLExtendedStreamReader reader, ModelElement element, ModelNode parentNode, List<ModelNode> addOperations) throws XMLStreamException;
